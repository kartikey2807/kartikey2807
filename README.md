...
<div align="justify">
I have recently completed my master's studies in data science, specializing in machine learning and statistics, at Uppsala University and have hands-on experience in generative modeling (e.g., LLMs, GANs, VAEs, etc.), privacy-based machine learning, and distributed learning on resource-constrained edge devices. I collaborated with researchers from Scania (during my thesis and summer job) and AI Sweden (independent project) to build models for production-ready deployments. Below, I talk more about my projects. Currently, I am building AI agents with RAG and MCP capabilities to build edge cases, test my codebase, and update it when failure occurs. This is an iterative implementation and helps keep the codebase up to date and error-free. Before my master's, I worked as a data analyst for over 2 years at a US-based healthcare startup. Look up my LinkedIn for more details. <i>Tools and languages I am proficient in.</i> -->
</div>
<br>
...
```
Sharma, K., Sharma, A., Bansal, S. (2023). Wasserstein GANs-Enabled Spectral Normalization on Credit Card Fraud Detection. In: Roy, S., Sinwar, D., Dey, N., Perumal, T., Tavares, J.M.R.S. (eds) Innovations in Computational Intelligence and Computer Vision. ICICV 2022. Lecture Notes in Networks and Systems, vol 680. Springer, Singapore. https://doi.org/10.1007/978-981-99-2602-2_13
```
